import { loadResolvedEnvIntoProcess } from '../shared/envFiles.mjs';

const envResolution = loadResolvedEnvIntoProcess();
if (!envResolution.primaryFound && envResolution.fallbackFound) {
  console.log('Dev env: .env not found. Using .env.example defaults.');
}
