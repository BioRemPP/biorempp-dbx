...
const userGuidePath = path.join(projectRoot, 'src', 'content', 'editorial', 'pages', 'user-guide.page.yaml');
...
function validateUserGuide(root) {
  ...
  root.categories.forEach((category, index) => {
    ...
    assertStringArray(category.when_to_use, `${categoryPath}.when_to_use`);
