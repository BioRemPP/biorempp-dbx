...
vi.mock('@shared/visualization/charts/ChartCard', () => ({
...
vi.mock('@shared/visualization/charts/HorizontalBarChart', () => ({
  HorizontalBarChart: () => <div>Horizontal Bar Chart</div>,
}));

vi.mock('@shared/visualization/charts/DonutChart', () => ({
  DonutChart: () => <div>Donut Chart</div>,
}));

vi.mock('@features/pathways/components/PathwayToxicityHeatmap', () => ({
