 ...
 *
 * Metadata panel for gene detail pages, focused on identifiers, interoperability lists, data
 * sources, and compact quantitative coverage metrics.
 */
import type { ReactNode } from 'react';
import type { GeneMetadata, GeneMetadataSource } from '@/features/genes/types';

/**
 * Props accepted by the gene metadata panel.
 */
interface GeneMetadataPanelProps {
  /** Normalized metadata payload returned by the gene metadata endpoint. */
...
/**
 * Renders identifiers, source provenance, and quantitative coverage metrics for a gene.
 *
 * @param props Metadata payload for the selected KO record.
 * @returns A two-section metadata panel with tokenized identifiers and summary metrics.
 *
 * @remarks
 * Identifier lists omit placeholder values such as `NA` before rendering the collapsible token
 * sections.
 */
