 ...
 *
 * Threshold overlay for guided-analysis scatter charts, including quadrant labels.
 */
import {
  SCATTER_MARGIN,
  SCATTER_PLOT_HEIGHT,
...
/**
 * Props accepted by the scatter-threshold overlay.
 */
interface ScatterThresholdOverlayProps {
  /** X coordinate of the vertical threshold line. */
  thresholdX: number;
  /** Y coordinate of the horizontal threshold line. */
  thresholdY: number;
}

/**
 * Renders threshold lines and quadrant labels for the guided scatter chart.
 *
 * @param props Threshold coordinates expressed in chart-space pixels.
 * @returns SVG overlay primitives for the scatter chart.
 */
