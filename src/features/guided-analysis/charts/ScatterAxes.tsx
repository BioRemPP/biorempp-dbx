 ...
 *
 * Axis renderer for guided-analysis scatter charts.
 */
...
/**
 * Props accepted by the scatter-axis renderer.
 */
interface ScatterAxesProps {
  /** Raw x-axis tick values to render along the scatter baseline. */
  xTicks: number[];
  /** Maximum domain value used to position x-axis ticks. */
  xMax: number;
  /** Scale mode used to convert raw x values into plotted positions. */
...
/**
 * Renders x and y axes, ticks, and labels for the scatter chart frame.
 *
 * @param props Tick values, domain bounds, scale mode, and axis label.
 * @returns SVG axis primitives for the guided scatter chart.
 */
