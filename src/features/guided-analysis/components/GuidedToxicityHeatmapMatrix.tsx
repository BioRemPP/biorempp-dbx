 ...
 *
 * Guided-analysis toxicity heatmap matrix that renders row-oriented matrix payloads returned by
 * guided executions.
 */
import type { GuidedHeatmapMatrixVisualizationData } from '@/features/guided-analysis/types';
...
/**
 * Props accepted by the guided toxicity heatmap matrix.
 */
interface GuidedToxicityHeatmapMatrixProps {
  /** Heatmap matrix payload returned by a guided execution visualization. */
...
/**
 * Renders a guided toxicity matrix with grouped endpoint headers and row metadata.
 *
 * @param props Guided heatmap-matrix payload returned by the backend.
 * @returns A scrollable toxicity heatmap matrix, or an empty-state message when no cells are available.
 */
