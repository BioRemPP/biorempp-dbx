 ...
 *
 * Compound-class explorer page with paginated search results and optional navigation into
 * class-specific detail overviews.
 */
...
/**
 * Props accepted by the compound-class explorer page.
 */
interface CompoundClassExplorerProps {
  /** Optional callback invoked when a result row opens a class detail view. */
  onCompoundClassSelect?: (compoundclass: string) => void;
}

/**
 * Renders the compound-class explorer with search and paginated aggregate results.
 *
 * @param props Optional compound-class selection callback for interactive table rows.
 * @returns The compound-class explorer layout with summary state and the result table.
 */
