 ...
 *
 * Shared button component and variant definitions used across interactive UI surfaces.
 */
...
/**
 * Variant map for shared button sizing and visual treatments.
 */
...
export interface ButtonProps
  ...
  /** Renders the button styles onto the child element instead of a native button. */
  asChild?: boolean;
}

/**
 * Renders the shared button primitive with project-specific variants.
 *
 * @param props Native button attributes, styling variants, and optional slot behavior.
