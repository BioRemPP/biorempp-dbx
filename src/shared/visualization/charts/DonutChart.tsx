 ...
 *
 * Shared donut chart that renders categorical proportions with a conic-gradient ring and legend.
 */
/**
 * One categorical slice rendered by the shared donut chart.
 */
export interface DonutSlice {
  ...
  label: string;
  /** Numeric slice value used for proportions and totals. */
  value: number;
  /** Optional explicit slice color override. */
  color?: string;
}

/**
 * Props accepted by the shared donut chart.
 */
interface DonutChartProps {
  /** Slice list to render in the donut chart. */
  slices: DonutSlice[];
  /** Message shown when no positive slices are available. */
  emptyMessage: string;
  /** Optional center label shown below the total. */
  centerLabel?: string;
}
...
/**
 * Renders a categorical donut chart with center total and textual legend.
 *
 * @param props Slice list, empty-state message, and optional center label.
 * @returns A donut chart, or an empty-state message when no positive slices are available.
 */
