...
description: Formal specification of the HADEG (Hydrocarbon Aerobic Degradation Enzymes and Genes) Database schema - 4-column structure for gene-pathway relationships in hydrocarbon degradation
keywords:
  - HADEG
  - database schema
...
This document provides a comprehensive technical specification of the HADEG (Hydrocarbon Aerobic Degradation Enzymes and Genes) Database schema, designed for bioinformatics researchers studying hydrocarbon biodegradation pathways.
...
**Source:** HADEG database (Hydrocarbon Aerobic Degradation Enzymes and Genes)
